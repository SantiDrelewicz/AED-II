...
public class BestEffortTests {
    ...
    @Test
    void despachar_con_mas_ganancia_misma_ganancia(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(2, 6, 5, 3000, 16),
            new Traslado(1, 2, 2, 3000, 41),
            new Traslado(7, 4, 0, 3000, 2),
        };

        BestEffort sis = new BestEffort(this.cantCiudades, nuevos);

        assertEquals(1, sis.despacharMasRedituables(1)[0]);
    }
    ...
    @Test
    void despachar_todos_con_mas_ganancia(){
        BestEffort sis = new BestEffort(this.cantCiudades, this.listaTraslados);

        sis.despacharMasRedituables(7);
    ...
    @Test
    void despachar_con_mas_ganancia_mas_de_n(){
        BestEffort sis = new BestEffort(this.cantCiudades, this.listaTraslados);
    ...
    @Test
    void despachar_con_mas_ganancia_maxima_en_extremos(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(4, 3, 4, 2500, 1),
            new Traslado(2, 2, 5, 400, 6),
            new Traslado(3, 5, 0, 250, 5),
            new Traslado(1, 2, 6, 600, 4),
            new Traslado(6, 1, 4, 1000, 3),
            new Traslado(5, 1, 2, 1000, 2),
            new Traslado(7, 1, 3, 2500, 7)
        };
    ...
    @Test
    void despachar_todos_mas_viejo(){
        BestEffort sis = new BestEffort(this.cantCiudades, this.listaTraslados);
    ...
    @Test
    void despachar_mas_viejo_mas_de_n(){
        BestEffort sis = new BestEffort(this.cantCiudades, this.listaTraslados);

        sis.despacharMasAntiguos(10);
    ...
    @Test
    void despachar_mas_antiguos_extremos(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(4, 3, 4, 2500, 2),
            new Traslado(2, 2, 5, 400, 4),
            new Traslado(3, 5, 0, 250, 50),
            new Traslado(1, 2, 6, 600, 42),
            new Traslado(6, 1, 4, 1000, 6),
            new Traslado(5, 1, 2, 1000, 3),
            new Traslado(7, 1, 3, 2500, 1)
        };
        ...
        assertSetEquals(new ArrayList<>(Arrays.asList(3, 4)), sis.ciudadesConMayorPerdida());
    ...
    @Test
    void despachar_mixto_mas_de_n(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(4, 3, 4, 200, 7),
            new Traslado(2, 2, 5, 400, 6),
            new Traslado(3, 5, 0, 250, 5),
            new Traslado(1, 2, 6, 600, 4),
            new Traslado(6, 1, 4, 1000, 3),
            new Traslado(5, 1, 2, 1000, 2),
            new Traslado(7, 1, 3, 950, 1)
        };
    ...
    @Test
    void mayor_superavit_mismo_superavit(){
        Traslado[] nuevos = new Traslado[] {
            new Traslado(4, 3, 4, 200, 1),
            new Traslado(2, 2, 5, 1050, 63),
            new Traslado(5, 1, 3, 1000, 12),
            new Traslado(3, 5, 2, 200, 2),
            new Traslado(1, 4, 1, 600, 52),
            new Traslado(6, 4, 0, 1400, 17),
            new Traslado(7, 2, 3, 950, 13)
        };
        ...
        sis.despacharMasAntiguos(8);
        assertEquals(2, sis.ciudadConMayorSuperavit());
    }

    @Test
    void mayor_superavit_mixto_misma_ganancia(){
        int nuevaCantCiudades = 8;

        Traslado[] nuevos = new Traslado[] {
            new Traslado(4, 0, 7, 1000, 1),
            new Traslado(2, 1, 6, 1000, 63),
            new Traslado(5, 2, 5, 1000, 12),
            new Traslado(3, 3, 4, 1000, 2),
            new Traslado(1, 4, 3, 1000, 52),
            new Traslado(6, 5, 2, 1000, 17),
            new Traslado(7, 6, 1, 1000, 13),
            new Traslado(8, 7, 0, 1000, 13)
        };

        BestEffort sis = new BestEffort(nuevaCantCiudades, nuevos);
